...
/// `BAAI/bge-small-en-v1.5`. Same v1.5 family as `BGEBaseEmbedder` —
...
/// Distinguished from `bge-base` by a smaller 384-dim embedding space
/// and fewer transformer layers, trading rubric quality for wallclock.
public actor BGESmallEmbedder: Embedder {

    public nonisolated let name = "bge-small-en-v1.5"
    public nonisolated let dimension = 384
