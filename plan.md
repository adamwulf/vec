...
Native implementation validation passed 131 focused tests. The 18-image sample contains 6 real and 12 synthetic images with 15 fixed queries. An initial run reported OCR hit@1 14/15, hit@5 15/15, MRR 0.967 and 19 chunks, with real-image targets 3/4 at rank one and synthetic targets 11/11; raw had no image chunks or hits. These figures are provisional: the uncommitted archive was lost during a worker-session restart and is being regenerated from unchanged frozen inputs. Only the regenerated, committed, independently scored archive will support the final report. This small selected sample and empty baseline do not estimate full-corpus retrieval accuracy.
